...
options = ["Home", "Experience", "Education", "Projects", "Languages"] 
icons = ['house', 'briefcase', 'mortarboard', 'clipboard-data', 'translate']

skills_dict = {"icon": "gear", "label": "Skills", "value": "Skills", "orientation": "vertical"}

selected = option_menu(None, options + [skills_dict], 
                       icons=icons + [skills_dict["icon"]],  
                       default_index=0,
